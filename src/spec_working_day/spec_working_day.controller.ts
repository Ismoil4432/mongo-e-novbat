...
export class SpecWorkingDayController {
  ...
  @Post('create')
  async create(@Body() createSpecWorkingDayDto: CreateSpecWorkingDayDto) {
  ...
  async findOneById(@Param('id') id: string) {
    return this.specWorkingDayService.findById(id);
  }

  @Patch(':id')
  async update(
    @Param('id') id: string,
    @Body() updateSpecWorkingDayDto: UpdateSpecWorkingDayDto,
  ) {
